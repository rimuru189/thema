...
check_token() {
  ...
  if [ "$USER_TOKEN" = "rimuru" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Fadhost${NC}"
    echo -e "${YELLOW}TELEGRAM : @namalj${NC}"
    echo -e "${YELLOW}WHATSAPP : no lu${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©namalu${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/rimuru189/thema/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/rimuru189/thema/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/rimuru189/thema/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/rimuru189/thema/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : namalu      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : namalh  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by namalu  ${NC}"
